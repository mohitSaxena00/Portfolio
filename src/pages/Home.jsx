  ...
  return (
    <div className="h-full w-full scroll-smooth select-none">
      ...
      <div className="navi bg-amber-300 flex justify-between h-[70px] sticky top-0 z-50">
        ...
        <h3 className="font-bold text-[25px] ml-10 mt-4">
          Portfolio
        </h3>
        ...
        <button
          className="font-bold text-[20px] mr-20 rounded-2xl border mt-3 h-[40px] w-[100px]
      ...
      <div id="home" className="flex bg-amber-200 h-[650px] w-full pt-15  scroll-mt-20">
        ...
        <div className="m-[60px] h-[400px] w-[500px] ">
          ...
          <h1 className="text-6xl md:text-8xl font-extrabold leading-none text-gray-900">
            Web Developer
          </h1>

          <p className="mt-8">
            I build modern and responsive websites with beautiful UI design,
            smooth animations and user-friendly experiences using Tailwind CSS.
          </p>
      ...
      <div id="about" className="bg-amber-200 h-[650px] w-full scroll-mt-20">
        ...
        <div className="flex ml-[90px]">
          ...
          <div className="h-[400px] w-[900px] font-medium mt-14 ml-14 leading-10">
            ...
            training in both Frontend and Backend web development and have
            built a strong foundation in modern web technologies.

            I enjoy creating responsive, attractive, and user-friendly
            websites that provide smooth and engaging user experiences.
            My skills include HTML, CSS, JavaScript, and other web
            development concepts that help me develop dynamic and
            functional web applications.

            As a learner and aspiring developer, I am always excited
            to explore new technologies and improve my technical skills
            through continuous practice and real-world projects.

            I believe in hard work, creativity, and consistency,
            which motivate me to grow every day in the field of web
            development.

            My goal is to become a successful software and web
            developer by gaining professional experience, building
            innovative projects, and contributing to meaningful
            digital solutions.
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-20 pt-6 mt-20">
          ...
          <div className="border-2 bg-white h-[270px] w-[360px] rounded-3xl ml-5 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl transition-all duration-500 cursor-pointer">
            ...
            <h1 className="font-bold text-[30px] h-[60px] w-[280px] mt-5 ml-6">
              Portfolio Website
            </h1>

            <p className="font-medium text-[17px] h-[100px] w-[300px] mt-3 ml-6">
              A personal portfolio website created using HTML and CSS
              to showcase my skills, education, and projects.
            </p>

            <div className="font-medium h-[40px] w-[120px] mt-3 ml-7">
              HTML + CSS
            </div>
          </div>
          ...
          <div className="border-2 bg-white h-[270px] w-[360px] rounded-3xl ml-5 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl transition-all duration-500 cursor-pointer">
            ...
            <p className="font-medium text-[17px] h-[70px] w-[300px] mt-3 ml-6">
              A responsive login page with clean UI design
              using HTML and CSS.
            </p>
          ...
          <div className="border-2 bg-white h-[270px] w-[360px] rounded-3xl ml-5 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl transition-all duration-500 cursor-pointer">
            ...
            <h1 className="font-bold text-[30px] h-[50px] w-[280px] mt-5 ml-6">
              Web Page
            </h1>

            <p className="font-medium text-[17px] h-[70px] w-[300px] mt-3 ml-6">
              An online resume layout including About,
              Skills, and Contact sections.
            </p>

            <div className="font-medium h-[40px] w-[200px] mt-3 ml-7">
              HTML + CSS + JavaScript
            </div>
          </div>
      ...
      <div
        id="contact"
        className="h-[650px] bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4 py-10"
      >
        ...
        <div className="w-full max-w-5xl grid md:grid-cols-2 bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="p-10 text-white flex flex-col justify-center">
            ...
            <p className="text-gray-300 mb-8 leading-7">
              Agar aapko website, portfolio ya frontend project
              banwana hai to mujhe message karo 🚀
            </p>
